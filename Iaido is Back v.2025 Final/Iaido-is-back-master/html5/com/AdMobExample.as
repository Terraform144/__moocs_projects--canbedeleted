...
public class AdMobExample extends Sprite
{
	...
	private function onRewardedVideoOpened(e:AdMobEvent):void
	{
		log("Rewarded video opened.");
	}
	
	/** On Rewarded Video Closed */
	private function onRewardedVideoClosed(e:AdMobEvent):void
	{
		log("Rewarded video closed.");
	}
	
	/** On Rewarded Video Started */
	private function onRewardedVideoStarted(e:AdMobEvent):void
	{
		log("Rewarded video started.");
	}
	
	/** On Rewarded Video Reward */
	private function onRewardedVideoRewarded(e:AdMobEvent):void
	{
...
//trace("[AdMobExample] "+msg);
	...
	public function createUI():void
	{
		...
		layout.addButton(new SimpleButton(new Command("Show Rewarded Video", showRewardedVideoAd)));
		layout.addButton(new SimpleButton(new Command("Preload Rewarded Video", preloadRewardedVideoAd)));
		layout.addButton(new SimpleButton(new Command("Show Pending Rewarded Video", showPendingRewardedVideo)));
